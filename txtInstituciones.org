...
* Presentación
Reportamos aquí la variación subnacional en las instituciones de reelección y el texto constitucional relevante. Para contextualizar la cronología del cambio, reportamos también el calendario electoral desde 1994. Y, donde resultan pertinentes, hacemos comentarios y anotaciones (en particular, acerca de discrepancias con la información de reelección legislativa que ha publicado el IMCO [[http://imco.org.mx/politica_buen_gobierno/reeleccion-legislativa-a-nivel-local/][aquí]]).
...
<table cellspacing="0" border="0">
	...
	<tr>
		...
		<td align="center" valign=bottom sdval="2024" sdnum="1033;">2014</td>
